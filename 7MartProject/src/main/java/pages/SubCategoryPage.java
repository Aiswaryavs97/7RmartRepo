...
public class SubCategoryPage  {
	...
	@FindBy(css="a.small-box-footer[href='https://groceryapp.uniqassosiates.com/admin/list-sub-category']") private WebElement subcategory;
	...
	@FindBy(xpath="//input[@class='form-control']") private WebElement entersubcategory;
	...
	public void clickOnNewButton() 
	{
	 ...
	 public void clickOnImageUpload() throws AWTException
	 {
		 ...
		 uploadimage.fileuploadusingSenkeys(imageupload,Constants.peace);//constants class.given image name in constants class
