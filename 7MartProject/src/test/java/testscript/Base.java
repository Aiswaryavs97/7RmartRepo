...
public class Base {
	...
	// public void initalizeBrowser()
	{
		...
		// driver = new ChromeDriver();// to loading the driver -- browser
		// initialization into the driver name
...
//common wait
	...
	/*
	 * public void driverQuitAndClose() { // driver.close();// to close the screen
	 * (closing only the parent window) //driver.quit();// closing all the windows }
	 */
